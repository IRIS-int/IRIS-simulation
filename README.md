...
- **Action bot (IBS agent)** — Ion Beam Shepherd (foil bus + ion emitter face + main thruster + control/coord panel). Flies its own orbit, faces debris (+Z), detumbles it with the ion beam, docks, pushes it to burnup with the thruster, then undocks and survives. Label: `ACTION-1`, `ACTION-2`, …
